...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('assets2/asset/css/bootstrap.min.css')}}">
      ...
      <!-- plugins -->
      <link rel="stylesheet" type="text/css" href="assets2/asset/css/plugins/font-awesome.min.css"/>
      <link rel="stylesheet" type="text/css" href="assets2/asset/css/plugins/simple-line-icons.css"/>
      <link rel="stylesheet" type="text/css" href="assets2/asset/css/plugins/animate.min.css"/>
      <link rel="stylesheet" type="text/css" href="assets2/asset/css/plugins/fullcalendar.min.css"/>
	<link href="assets2/asset/css/style.css" rel="stylesheet">
	<!-- end: Css -->

	<link rel="shortcut icon" href="assets2/asset/img/logomi.png">
 ...
 <body id="mimin" class="dashboard">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Akihiko Avaron</span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="assets2/asset/img/avatar.jpg" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
                            ...
                            <div class="col-md-12 padding-0">
                              <div class="panel box-v2">
                                  <div class="panel-heading padding-0">
                                    <img src="assets2/asset/img/bg2.jpg" class="box-v2-cover img-responsive"/>
                                    <div class="box-v2-detail">
                                      <img src="assets2/asset/img/avatar.jpg" class="img-responsive"/>
              ...
              <div class="tab-content">
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="assets2/asset/img/avatar.jpg" alt="user name">
                      <div class="name">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="assets2/asset/img/avatar.jpg" class=" img-responsive " alt="user name">
                            </div>
                          </div>
                                ...
                                <ul>
                                  <li class="online">
                                    <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                      <div class="user-avatar"><img src="assets2/asset/img/avatar.jpg" alt="user name"></div>
                                      <div class="dot"></div>
                                    </a>
                                  </li>
                                  <li class="offline">
    ...
    <!-- start: Javascript -->
    <script src="assets2/asset/js/jquery.min.js"></script>
    <script src="assets2/asset/js/jquery.ui.min.js"></script>
    <script src="assets2/asset/js/bootstrap.min.js"></script>
   
    
    <!-- plugins -->
    <script src="assets2/asset/js/plugins/moment.min.js"></script>
    <script src="assets2/asset/js/plugins/fullcalendar.min.js"></script>
    <script src="assets2/asset/js/plugins/jquery.nicescroll.js"></script>
    <script src="assets2/asset/js/plugins/jquery.vmap.min.js"></script>
    <script src="assets2/asset/js/plugins/maps/jquery.vmap.world.js"></script>
    <script src="assets2/asset/js/plugins/jquery.vmap.sampledata.js"></script>
    <script src="assets2/asset/js/plugins/chart.min.js"></script>


    <!-- custom -->
     <script src="assets2/asset/js/main.js"></script>
