...
<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
    <tr>
        ...
        <td>
            <input type="text" name="kode_golongan" value="<?php echo e($golongan->kode_golongan); ?>" class="form-control"></input>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="nama_golongan" value="<?php echo e($golongan->kode_golongan); ?>" class="form-control"></input>
             <?php echo e($errors->first('kode_golongan', ':message')); ?>
