<?php $__env->startSection('content'); ?>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="col-md-0 col-sm-12">
                        ...
                        <div class="col-md-0 col-sm-0">
                             <a href="<?php echo e(url('tunjangan/create')); ?>"> <button class=" btn btn-circle btn-gradient btn-danger" value="primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form action="<?php echo e(url('tunjangan')); ?>/?kode_tunjangan=kode_tunjangan"> <input type="text" name="kode_tunjangan"> <button type="submit" class="btn btn-primary">
                                    cari
                                </button>
 ...
 <tr>
                                            ...
                                            <td><a href="<?php echo e(route('tunjangan.edit',$tunjangans->id)); ?>" class="btn btn-success">Ubah</a></td>
             <td>
