...
<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
    <tr>
        ...
        <td>
            <input type="text" name="kode_lembur_id" value="<?php echo e($lembur_pegawai->kode_lembur_id); ?>" class="form-control"></input>
    ...
    <tr>
        ...
        <td>
        <input type="text" name="pegawai_id" value="<?php echo e($lembur_pegawai->pegawai_id); ?>" class="form-control"></input>
